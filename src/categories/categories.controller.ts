...
export class CategoriesController {
    ...
    @ApiOperation({
        ...
        description: 'Retrieves a paginated list of categories with optional search and filtering'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Returns category suggestions based on search query for autocomplete functionality'
    })
    @ApiQuery({
        name: 'q',
    ...
    @ApiOperation({
        ...
        description: 'Marks a category as inactive (soft delete) - can be restored later'
    })
    @ApiParam({
        name: 'id',
        description: 'Category ID',
    ...
    @ApiOperation({
        ...
        description: 'Permanently removes a category from the database - cannot be restored'
    })
    @ApiParam({
        name: 'id',
        description: 'Category ID',
