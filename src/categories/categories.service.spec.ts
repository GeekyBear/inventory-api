...
describe('CategoriesService', () => {
    ...
    beforeEach(async () => {
        ...
        const MockModel: any = jest.fn().mockImplementation((data) => ({
            ...data,
            save: jest.fn().mockResolvedValue({ ...data, _id: '64a7b8c9d1234567890abcde' }),
        }));
        ...
        MockModel.findByIdAndUpdate = jest.fn().mockReturnValue(createChainableMock(mockCategory));
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException when category not found', async () => {
            ...
            await expect(service.findOne('64a7b8c9d1234567890abcde')).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('findBySlug', () => {
        it('should return a category by slug', async () => {
            ...
            expect(model.findOne).toHaveBeenCalledWith({ slug: 'electronics', isActive: true });
            expect(result).toBeInstanceOf(CategoryResponseDto);
        });
    ...
    describe('update', () => {
        it('should update a category successfully', async () => {
            ...
            const result = await service.update('64a7b8c9d1234567890abcde', updateCategoryDto);
        ...
        it('should throw NotFoundException when category not found', async () => {
            ...
            await expect(service.update('64a7b8c9d1234567890abcde', updateCategoryDto)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('remove', () => {
        it('should soft delete a category successfully', async () => {
            ...
            await expect(service.remove('64a7b8c9d1234567890abcde')).rejects.toThrow(NotFoundException);
        });
    });
