...
describe('ProductsService', () => {
    ...
    beforeEach(async () => {
        ...
        const MockProductModel: any = jest.fn().mockImplementation((data) => ({
            ...data,
            save: jest.fn().mockResolvedValue({ ...data, _id: '64a7b8c9d1234567890abcdf' }),
        }));
        ...
        MockProductModel.findById = jest.fn().mockReturnValue(createChainableMock(null));
        MockProductModel.findOne = jest.fn().mockReturnValue(createChainableMock(null));
        MockProductModel.findByIdAndUpdate = jest.fn().mockReturnValue(createChainableMock(mockProduct));
        MockProductModel.countDocuments = jest.fn().mockResolvedValue(0);

        MockCategoryModel.findById = jest.fn().mockReturnValue(createChainableMock(null));
    ...
    describe('create', () => {
        it('should create a new product successfully', async () => {
            ...
            expect(categoryModel.findById).toHaveBeenCalledWith(createProductDto.categoryId);
    ...
    describe('findOne', () => {
        it('should return a product by id', async () => {
            ...
            expect(productModel.findById).toHaveBeenCalledWith('64a7b8c9d1234567890abcdf');
            expect(result).toBeInstanceOf(ProductResponseDto);
        });
        ...
        it('should throw NotFoundException when product not found', async () => {
            ...
            await expect(service.findOne('64a7b8c9d1234567890abcdf')).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('update', () => {
        it('should update a product successfully', async () => {
            ...
            const result = await service.update('64a7b8c9d1234567890abcdf', updateProductDto);
        ...
        it('should throw NotFoundException when product not found', async () => {
            ...
            await expect(service.update('64a7b8c9d1234567890abcdf', updateProductDto)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('updateStock', () => {
        ...
        it('should throw NotFoundException when product not found', async () => {
            ...
            await expect(service.updateStock('64a7b8c9d1234567890abcdf', 45)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('remove', () => {
        it('should soft delete a product successfully', async () => {
            ...
            await expect(service.remove('64a7b8c9d1234567890abcdf')).rejects.toThrow(NotFoundException);
        });
    });
