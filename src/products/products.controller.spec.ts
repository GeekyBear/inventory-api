...
describe('ProductsController', () => {
    ...
    describe('create', () => {
        it('should create a new product', async () => {
            const createProductDto: CreateProductDto = {
                name: 'Test Product',
                description: 'Test Description for the test product with enough characters',
                price: 99.99,
                sku: 'TEST-001',
                categoryId: '507f1f77bcf86cd799439012',
                brand: 'Test Brand',
    ...
    describe('findByCategory', () => {
        it('should return products by category', async () => {
            ...
            expect(productsService.findByCategory).toHaveBeenCalledWith(categoryId, queryDto);
            expect(result.success).toBe(true);
            expect(result.message).toBe('Products by category retrieved successfully');
            expect(result.data).toEqual(mockPaginatedResult);
        });
    });
